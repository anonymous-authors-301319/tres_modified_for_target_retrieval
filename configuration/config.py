...
domain = "TargetRetrieval"     # give the name of the domain of your interest  
...
# CRAWLING
TOTAL_TIME_STEPS = 10000000      # we used 20000
...
MAX_DOMAIN_PAGES = 1000000           # maximum number of domain (web site) web pages to be fetched by the crawler
...
SUFFIX_STR = db_name  # Give a name for your suffix save file (without .filetype)
