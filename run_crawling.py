import tracker
import sys
tracker.config_file_name = sys.argv[1]
...
if __name__ == "__main__":
    ...
    while(True):
        ...
        new_url, state_page, reward, done, _ = agent.env.step(action=page.id)
        if state_page == False:
            continue
        ...
        try:
            ...
            extractedURLS = agent.env.extractStateActions(new_url)     # list of Webpage
        except: 
